...
async def list_roles(admin: Employee = Depends(require_employee_permission(Permission.VIEW_EMPLOYEES))):
...
async def create_role(
    role_in: RoleCreate,
    admin: Employee = Depends(require_employee_permission(Permission.ASSIGN_ROLES))
):
